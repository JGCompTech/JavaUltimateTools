...
public class PasswordHashingFailedException extends RuntimeException {
    /**
     * Constructs a new {@link PasswordHashingFailedException} with the specified detail message.
    ...
    /**
     * Constructs a new {@link PasswordHashingFailedException} with the specified detail message and
    ...
    /**
     * Constructs a new {@link PasswordHashingFailedException} with the specified cause and a
