...
public class UserManagerException extends RuntimeException {
    /**
     * Constructs a new {@link UserManagerException} with the specified detail message.
    ...
    /**
     * Constructs a new {@link UserManagerException} with the specified detail message and
    ...
    /**
     * Constructs a new {@link UserManagerException} with the specified cause and a
